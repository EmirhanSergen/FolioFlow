                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <!-- Changed $totalProfitLoss to $activeProfitLoss -->
                            <p class="text-2xl font-semibold <?= $activeProfitLoss >= 0 ? 'text-emerald-600' : 'text-red-600' ?>">
                                <?= $activeProfitLoss >= 0 ? '+' : '-' ?>$<?= number_format(abs($activeProfitLoss), 2) ?>
                            </p>
                            <p class="text-sm text-gray-500">Active Positions</p>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <!-- Changed "All Time" to "Active Positions" -->
